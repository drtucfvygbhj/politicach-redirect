# politicach.ch — redirect to politikch.ch

This repository exists only to serve `politicach.ch` over **HTTPS** and forward it to
the main site in it (`https://politikch.ch/?lang=it`).
